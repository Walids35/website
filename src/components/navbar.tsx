...
const NavBar = () => {
  const buttonStyle = "dark:hover:text-white hover:text-gray-500 duration-300 transition-all";
  const [theme, toggleTheme] = useDarkMode() as [string, () => void];

  return (
    <nav className="w-full dark:text-gray-400 sticky top-0 z-50 bg-background/75 py-8 backdrop-blur-sm">
